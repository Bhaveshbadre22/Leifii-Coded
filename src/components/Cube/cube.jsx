...
function CubeComponent() {
  ...
  // Optimized motion values for smooth animation
  ...
  return (
    <div ref={container}>
      <Canvas>
        {/* Disabled OrbitControls rotation for smoother behavior */}
...
function MyCube({ rotationX, rotationY }) {
  ...
  // Preload all textures once to prevent blocking UI
